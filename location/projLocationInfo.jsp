...
try{
	...
	List<GroupLocationVo> userLocationList = locationDao.usersLocation(projId,"0");
	pageContext.setAttribute("locationList", userLocationList);
}catch(Exception e){
e.printStackTrace();
}
...
<link rel="stylesheet" href="http://cache.amap.com/lbs/static/main.css?v=1.0?v=1.0" />
	...
	<script type="text/javascript">
         ...
         var longitude ,latitude;
           ...
           <c:forEach var="sale" items="${location.saleList}" >
	           longitude = ${sale.longitude};
	           latitude = ${sale.latitude};
	           	 marker = new AMap.Marker({
	            	content:'<div class="marker" >${sale.userName}</div>',
...
<body onload="init();")>
<div id="aa" class="div-left"><table><tr><td>${projName }</td></tr></table></div>

...
<script type="text/javascript">
		...
		function saveOrUpdate(){
			...
			ajax.remoteCall("${path}/com.pytech.timesgp.web.dao.CustomerDao:batchUpdateSaler",[postData],function(reply){
				isClick = false;
				Form.closeWaiting();
...
<body style="overflow: hidden;">
	<form action="" id="dataForm">
		...
		<div style="margin-top: 5px;">
			<span style="color: red;padding-left:10px;">注：请导出客户列表,在列表的最后两列‘调整后归属销售员’,‘调整后归属销售组’填写需调整的销售人员和小组并导入文件</span>
		</div>

...
<script type="text/javascript">
                ...
                function closeDialog(){
                        parent.art.dialog.get("batchImportPg").close();
                }
                ...
                function saveOrUpdate(){
                        ...
                        var serviceUrl = "${path}/com.pytech.timesgp.web.dao.ClientDao:addClientByExcelDao";
...
<body style="overflow: hidden;">
        <form action="" id="dataForm">
                ...
                <div style="margin-top: 5px;">
                        <span style="color: red;">注：请下载<a href="${path}/pages/client/mgrselect/client-template.xls" style="font-size: 17px;">模板</a>,按照模板文件填写数据后并导入文件</span>
                </div>

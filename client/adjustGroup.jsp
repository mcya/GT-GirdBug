...
<script type="text/javascript">
		...
		function closeDialog(){
			parent.art.dialog.get("client").close();
		}
		...
		function save(){
			...
			postData.CUST_ORG_ID = group;
			postData.PUBLIC_STATUS = 3;
			/* postData.SALE_NAME = name;
			postData.FOLLOW_TYPE = 2; */
			
			var serviceUrl = "${path}/com.pytech.timesgp.web.dao.CustomerDao:adjustCustGroupNew";
			if(isClick == false){
				isClick = true;
			}else{
	...
	<form action="" id="dataForm" style="">
		...
		<table width="100%" cellspacing="2" cellpadding="2" style="margin-top: 10px;margin-left: -30px">
			...
			<tr>
				...
				<td>
					<select id="group" name="group" class="textbox" onchange="selectUser($(this))" style="width:100%">
			...
			<tr>
				...
				<td>
					<select id="user" name="user" class="textbox" style="width:100%">
						<option value="">--请选择--</option>
					</select>
				</td>
			</tr>

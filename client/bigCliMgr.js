...
function gridQuery() {
	...
	if(!params.PUBLIC_STATUS || params.PUBLIC_STATUS=='')
		params.PUBLIC_STATUS=$('div#quickSearch span.selected').attr('val');
	Form.showWaiting();
...
function freeCust(id){
	ajax.remoteCall(path+"/com.pytech.timesgp.web.dao.CustomerDao:changeCustToPublicNew",[id],function(reply){

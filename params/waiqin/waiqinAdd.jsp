		...
		$("#ADDR").on('click', function(e){
			...
			if (isUpdatee==0) {
				dialogUtil.open(
					"addChannel",
					"选择地图",
					path+"/pages/params/waiqin/gaodeMap.jsp?isAddFlag=1",550,860,
				...
				dialogUtil.open(
					"addChannel",
					"选择地图",
					path+"/pages/params/waiqin/gaodeMap.jsp?isAddFlag=0",550,860,
					function(e, value, recoer){
						var lnlaAddr = JSON.parse(localStorage.getItem("lnlaAddr"))
						saveName = e.saveName;
						saveInfo = e.saveInfo;
	...
	function saveOrUpdate() {
		...
		if(isUpdatee==0) {
			...
			ajax.remoteCall(path+
				"/com.pytech.timesgp.web.dao.WqWorkplaceDao:addWqWorkplace",
			...
			ajax.remoteCall(path+
				"/com.pytech.timesgp.web.dao.WqWorkplaceDao:updateWqWorkplace",
				...
				<input type="hidden" id="ORG_TYPE" name="ORG_TYPE" value='${orgType}'>
					<table>
						...
						<tr>
							...
							<td>
								<ui:TextBox id="test3"></ui:TextBox></td>
							</td>
						</tr>
						<tr style="height: 30px;"></tr>
						<tr>

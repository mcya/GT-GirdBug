...
function addChannel(){
	window.location.href=path+"/pages/params/shangban/shangbanAdd.jsp?isUpdate=0"
}
...
function updateChannel(){
	...
	window.location.href=path+"/pages/params/shangban/shangbanAdd.jsp?isUpdate=1"
}
...
function deleteChannel(){
	...
	dialogUtil.confirm('确认要删除选择的记录吗？',function(){
		...
		ajax.remoteCall(path+"/com.pytech.timesgp.web.dao.WorkplaceDao:deleteWorkplace",[paramsObj],function(reply){

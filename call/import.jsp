	...
	<div id="baseContainer" style="overflow: hidden;">
		<div id="content" style="float: left;">
			...
			<ui:Grid dataProvider="${path}/com.pytech.timesgp.web.query.CalleeQuery" singleSelect="false" autoLoad="true" parameters="" style="width: 100%;padding: 0px;margin: 0px;overflow: hidden" id="grid">
				...
				<ui:GridField id="CALLEE_NAME" width="100" header="姓名" align="center" ></ui:GridField>
				<ui:GridField id="CALLEE_NUMBER" width="150" header="电话号码" toolTip="true" align="center"></ui:GridField>
				<ui:GridField id="IMPORT_TIME" width="200" header="创建时间" toolTip="true" align="center"></ui:GridField>
			</ui:Grid>
		</div>
	</div>
</body>

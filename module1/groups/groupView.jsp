...
<%
	...
	String id = request.getParameter("USER_MOBILE");
...
<html>
<head>
<meta http-equiv="Content-Type" content="text/html; charset=utf-8"><meta http-equiv="X-UA-Compatible" content="IE=EmulateIE10,EmulateIE9" /><meta http-equiv="X-UA-Compatible" content="IE=EmulateIE10,EmulateIE9" />
<style type="text/css">
.label {
	text-align: right
}
...
<body style="overflow: hidden;">
		...
		<table width="100%" cellspacing="2" cellpadding="2" style="margin-top: 10px;margin-left: -30px">
			...
			<tr>
				...
				<td>
					<input class="textbox" value="${user.USER_AGE }">
				</td>
			</tr>
